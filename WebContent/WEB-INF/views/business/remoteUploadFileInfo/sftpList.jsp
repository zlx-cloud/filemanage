...
<body class="layui-view-body">
			...
			<div class="layui-card-body">
				<div class="form-box">
					...
					<table class="layui-table" lay-filter="dataTable"
						lay-data="{url:'${ctx}/remoteUploadFileInfo/sftpList', method:'post',page:true,
						...
						<thead>
							<tr>
								...
								<th lay-data="{field:'uploadTime',align:'center',width:'13%'}">上传时间</th>
								...
								<th lay-data="{field:'filePath',align:'center',width:'30%'}">文件上传路径</th>
	...
	<script>
		...
		function reloadTable(){
			table.reload('dataTable', {
				url:'${ctx}/remoteUploadFileInfo/sftpList',
				page : {
					curr : 1
				},
				method : 'post',
