...
public class RedisUtil {
	...
	// =============================common============================
	// 模糊查询
	public Set<String> afterMatch(String key) {
		Set<String> keys = redisTemplate.keys(key);
		return keys;
	}

	// 根据key批量查询
	public List<Object> getValuesByKeys(List<String> keys) {
	 ...
	 * TypedTuple<Object> objectTypedTuple1 = new DefaultTypedTuple
	 * <Object>("zset-5",9.6);<br>
